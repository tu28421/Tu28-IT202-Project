...
?>
   ...
   if ($item) {
   ?>
       <h2>Update Item <?php echo $item->SUSTAINABLELIVINGID; ?></h2><br>
       <form name="items" action="index.php" method="post">
           <table>
               <tr>
                   <td>ItemID</td>
                   <td><?php echo $item->SUSTAINABLELIVINGID; ?></td>
               </tr>
               <tr>
               <td>Name</td>
                   <td><input type="text" name="itemName" value="<?php echo $item->SUSTAINABLELIVINGName; ?>"></td>
               </tr>
               <tr>
                   <td>Category ID</td>
               <td><input type="text" name="categoryID" value="<?php echo $item->SUSTAINABLELIVINGCategoryID; ?>"></td>
               </tr>
               <tr>
                   <td>List Price</td>
                 <td><input type="text" name="listPrice" value="<?php echo $item->SUSTAINABLELIVINGListPrice; ?>"></td>
               </tr>
           </table><br><br>
